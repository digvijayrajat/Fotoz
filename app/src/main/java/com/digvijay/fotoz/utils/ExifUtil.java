...
public class ExifUtil {
    ...
    public static ExifInterface getExifInterface(Context context, Uri albumItem) {
        if (albumItem == null) {
            return null;
        }
    ...
    public static ExifItem[] retrieveExifData(Context context, Uri uri) {
        ExifInterface exif = getExifInterface(context, uri);
        if (exif != null) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.N)
    public static int getExifOrientationAngle(Context context, Uri albumItem) {
